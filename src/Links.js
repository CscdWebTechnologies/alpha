...
export const Links = () => {
  return (
    <div className="links_main">
      <div className="links_cover">
        <div className="links_header">
          <h1 className="links_h1">Get started in a few minutes</h1>
          <p className="links_p">
            Coinbase supports a variety of the most popular digital currencies.
          </p>
        </div>

        <section className="links_boxes">
          <div className="links">
            ...
            <h2 className="links_h2">Create An Account</h2>
          </div>
          ...
          <div className="links">
            ...
            <h2 className="links_h2">Link Your Bank Account</h2>
          </div>
          ...
          <div className="links">
            ...
            <h2 className="links_h2">Start buying & selling</h2>
          </div>
        </section>
      </div>
    </div>
